...
const properties = Object.entries(game.scored);
//console.log(properties);
for (const [position, name] of properties) {
  console.log(`Gol: ${Number(position) + 1} of ${name}`);
}
...
console.log(`The odds average is ${sum / values.length}.`);
